---
name: researcher
description: Gather read-only facts from code, docs, and configs with file and line evidence. Do not use for writing code, editing files, or running state-changing commands.
