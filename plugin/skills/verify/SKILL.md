---
name: verify
description: Prove a change with the repository's own gates before reporting done. Do not use for verification-free reporting, and never narrow a run to exclude a failure.
