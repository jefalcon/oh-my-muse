...
[![CI](https://github.com/example/oh-my-muse/actions/workflows/ci.yml/badge.svg)](https://github.com/example/oh-my-muse/actions/workflows/ci.yml)
...
```sh
git clone https://github.com/example/oh-my-muse.git
cd oh-my-muse
